...
export default function Hero() {
  return (
    <AnimatedSection className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 pt-20" id="home">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <article className="flex-1 text-center md:text-left">
            ...
            <FadeInStagger delay={300}>
              <p className="text-xl sm:text-2xl md:text-3xl text-zinc-700 dark:text-zinc-300 mb-6" role="doc-subtitle">
                DevSecOps Engineer
              </p>
            </FadeInStagger>
            ...
            <FadeInStagger delay={700}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  ...
                  aria-label="Contact Firas Mosbehi"
                >
                  Get in Touch
                </Link>
                <a
                  ...
                  aria-label="Download Firas Mosbehi's CV (PDF)"
                >
                  View CV
                </a>
              </div>
